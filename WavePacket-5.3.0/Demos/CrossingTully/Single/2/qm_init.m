...
hamilt.nip.exp  = 3;                     % Exponent
hamilt.nip.min = -8;                     % Beginning of inner grid region
hamilt.nip.max =  8;                     % End of inner grid region
...
psi.dof{1}.mom_0 =  8.2;                 % Center in momentum representation
