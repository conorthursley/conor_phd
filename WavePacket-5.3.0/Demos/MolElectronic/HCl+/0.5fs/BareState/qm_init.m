...
time.main.delta  = 10/atomic.t.as;       % Size of time steps: 10 as 
...
time.efield.delay   = 0.25/atomic.t.fs;  % Time delay of pulse center: 0.25 fs
time.efield.fwhm    = 0.25/atomic.t.fs;  % Full width at half maximum: 0.25 fs
