...
hamilt.pot.d_e = 37244/atomic.w.cm_1;    % dissociation energy
hamilt.pot.r_e = 1.2746/atomic.l.A;      % equilibrium length
hamilt.pot.alf = 2.38/(1.2746/atomic.l.A);% range parameter
