...
plots.density.surface.view  = [30 30];   % Bottom view (without potentials)
...
plots.expect.energies.max   = +05;       % manual setting of maximum of energy expct. plot

plots.expect.population.min = -0.01;
