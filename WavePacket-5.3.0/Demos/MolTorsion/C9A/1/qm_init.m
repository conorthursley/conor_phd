...
util.disp ( '**********************************************' )
util.disp ( 'Calculation of the vibrational spectrum of the' )
util.disp ( 'S0 state of 9-(N-carbazolyl)-anthracene (C9A) ' )
...
hamilt.pot.state= 1;              % ground state surface of C9A
