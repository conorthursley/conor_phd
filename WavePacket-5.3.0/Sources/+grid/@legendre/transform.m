...
% 2. We want to extend the matrix to more or less polynomials. This can be done
...
if n_pts == obj.l_max - abs(obj.m_0) + 1
    trafo = original;
...
if n_pts > obj.l_max - abs(obj.m_0) + 1
    ...
    dimensions(obj.dof) = n_pts - (obj.l_max - abs(obj.m_0) + 1);
...
if isempty(tmpdof) || (tmpdof.l_max - abs(tmpdof.m_0) + 1) ~= n_pts
    tmpdof = obj;
    tmpdof.l_max = obj.m_0 + n_pts - 1;
