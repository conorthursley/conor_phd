...
file = 'C:\ANSYS\Temp\Validation\DuffingValDec17\DuffOneUnitTrans16.csv';
...
bandpassFile='C:\ANSYS\Temp\Validation\DuffingValDec17\bandpassFilter.csv';
bandpass=csvread(bandpassFile);

% [txy,frequencies]=tfestimate(bandpass(:,2),ansys_amp_1,[],[],[],500);
[txy,frequencies]=tfestimate(bandpass(:,2),ansys_amp_2,[],[],[],500);

% plot
figure
plot(frequencies/w0,20*log10(abs(txy)))
grid on
