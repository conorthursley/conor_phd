...
file = 'C:\ANSYS\Temp\Validation\DuffingValDec17\DuffOneUnitTrans57.csv';
...
% bandpassFile='C:\ANSYS\Temp\Validation\DuffingValDec17\lowpassFilterFs14000Amp10Length100ValidationYao2008.csv';
% bandpass=csvread(bandpassFile);
bandpass=10*sin(10*2*pi*t);
...
[txy,frequencies]=tfestimate(ansys_amp_2,ansys_amp_1,[],[],[],142.8571);
