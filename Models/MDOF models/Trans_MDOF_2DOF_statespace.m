...
%% Import comparison 
M='U:\_PhD\Datathief\2DOF_FreeResponse_InmanEngVib\figure3_x1.csv';
data=csvread(M,1,0);
N='U:\_PhD\Datathief\2DOF_FreeResponse_InmanEngVib\figure3_x2.csv';
data1=csvread(N,1,0);
%% Plot the results
% Plot the time series
figure
plot1=plot(t,x(:,1),'r*',t,(x(:,2)/3),'b+',data(:,1),data(:,2),'g',data1(:,1),data1(:,2),'c');
